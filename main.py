...
# Importamos las clases y el torneo de los archivos de nuestros compañeros
from conf_torneo import torneo_actual
from clases import equipo, partido


# ===========================================================================
# PERSISTENCIA: GUARDAR Y CARGAR DATOS EN ARCHIVO DE TEXTO (sin JSON ni diccionarios)
# ===========================================================================
...
# ===========================================================================
# ESTRUCTURAS DE DATOS: PILA Y COLA (obligatorias para la materia)
# ===========================================================================

# PILA: guarda el historial de pantallas visitadas para poder volver atras
# Operacion push: historial_pantallas.append(pantalla)
# Operacion pop:  historial_pantallas.pop()
historial_pantallas = []

# COLA: guarda los partidos pendientes de registrar resultado en orden de llegada
# Operacion enqueue: cola_partidos.append(partido)
# Operacion dequeue: cola_partidos.pop(0)
cola_partidos = []
...
if __name__ == "__main__":
    ...
    # Creamos la ventana raiz de Tkinter
    raiz_tk = tk.Tk()
